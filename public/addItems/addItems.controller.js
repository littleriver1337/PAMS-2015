...
angular
  .module('pamsAddItems')
  .controller('AddItemsController', function ($scope, AdminService, LoginService, VerificationService, CompanyService, RetailerService, AddItemsService, $routeParams, _) {
    var vm = this;
